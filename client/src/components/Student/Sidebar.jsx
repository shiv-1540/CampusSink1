...
const Sidebar = () => {
  ...
  return (
    <div className="bg-white border-end vh-100 d-flex flex-column justify-content-between" style={{ width: "240px" }}>
      <div>
        ...
        <ul className="nav flex-column px-3">
          ...
          <li className="nav-item mb-2">
            <Link className="nav-link text-dark" to="/student/assignments">
              <FaBook className="me-2" /> My Assignments
            </Link>
          </li>
          <li className="nav-item mb-2">
            <Link className="nav-link text-dark" to="/student/seminars">
              <FaChalkboardTeacher className="me-2" /> Seminars
            </Link>
          </li>
          <li className="nav-item mb-2">
            <Link className="nav-link text-dark" to="/student/reviews">
              <FaClipboardList className="me-2" /> Project Reviews
            </Link>
          </li>
        </ul>
      </div>
