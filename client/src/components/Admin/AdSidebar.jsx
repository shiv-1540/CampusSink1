...
const AdSidebar = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/addusers', label: 'User Management', icon: <FaFileAlt /> },
    { path: '/admin/reports', label: 'Reports/Analytics', icon: <FaFileAlt /> },
    { path: '/admin/settings', label: 'Manage Settings', icon: <FaBookOpen /> },
  ];
