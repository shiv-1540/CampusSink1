...
const AdSidebar = () => {
  ...
  const menuItems = [
    { path: '/admin/dashboard', label: 'Dashboard', icon: <FaTasks /> },
    { path: '/admin/addusers', label: 'Manage Users', icon: <FaFileAlt /> },
    { path: '/teacher/view-assignments', label: 'View/Edit Assignments', icon: <FaFileAlt /> },
    { path: '/teacher/manage-deadlines', label: 'Manage Deadlines', icon: <FaClock /> },
    { path: '/teacher/project-reviews', label: 'Project Reviews', icon: <FaBookOpen /> },
